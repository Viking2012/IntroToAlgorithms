...
var tests = []testpair{
	...
	{IntSlice([]int{74, 59, 238, -784, 9845, 959, 905, 0, 0, 42, 7586, -5467984, 7586}), IntSlice([]int{-5467984, -784, 0, 0, 42, 59, 74, 238, 905, 959, 7586, 7586, 9845})},
}

func TestHeapsort(t *testing.T) {
	for _, pair := range tests {
		testVal := HeapSort(pair.values)
